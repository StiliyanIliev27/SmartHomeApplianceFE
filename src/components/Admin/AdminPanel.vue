    ...
    <div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        <main class="ml-60 pt-16 max-h-screen overflow-auto">
            ...
            <div class="p-6">
                <!-- Welcome Message -->
                <div class="mb-6">
                    <h1 class="text-2xl font-bold text-gray-900 mb-1">Welcome to Admin Dashboard</h1>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-xl p-4 shadow hover:shadow-lg transition-shadow duration-300">
                        <div class="flex items-center justify-between">
                            <div>
                                <div class="text-sm font-medium text-gray-500 mb-1">Products</div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow">
                        <h2 class="text-lg font-bold text-gray-900 mb-4">Recent Activities</h2>
                        <div class="space-y-4">
                            <div v-for="(activity, index) in recentActivities" :key="index" 
                                ...
                                <div>
                                    <p class="text-sm text-gray-800 font-medium">{{ activity.activityDescription }}</p>
                    ...
                    <!-- Top Products -->
                    <div class="bg-white rounded-xl p-6 shadow">
                        <h2 class="text-lg font-bold text-gray-900 mb-4">Top Performing Products</h2>
                        <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white rounded-xl p-6 shadow">
                        <h2 class="text-lg font-bold text-gray-900 mb-4">Customer Satisfaction</h2>
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-700">Overall Rating</span>
                                <span class="text-xl font-bold text-amber-500">{{ overallRating }}/5.0</span>
                            </div>
                    ...
                    <!-- Inventory Status -->
                    <div class="bg-white rounded-xl p-6 shadow">
                        <h2 class="text-lg font-bold text-gray-900 mb-4">Inventory Status</h2>
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-700">Low Stock Items</span>
                                <span class="text-sm font-semibold text-red-500">{{ inventoryStatus.lowStockItems }} items</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-sm font-medium text-gray-700">Out of Stock</span>
                                <div v-if="inventoryStatus.outOfStockItems > 0">
                                    <span class="text-sm font-semibold text-red-500">{{ inventoryStatus.outOfStockItems }} items</span>
                                </div>
                                <div v-else>
                                    <span class="text-sm font-semibold text-emerald-500">All items in stock</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl p-6 shadow">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button class="p-3 text-sm font-medium bg-indigo-50 text-indigo-600 rounded-lg hover:bg-indigo-100 transition-colors duration-200">
                                Add Product
                            </button>
                            <button class="p-3 text-sm font-medium bg-emerald-50 text-emerald-600 rounded-lg hover:bg-emerald-100 transition-colors duration-200">
                                New Order
                            </button>
                            <button @click="generateAdminDashboardPDF" class="p-3 text-sm font-medium bg-violet-50 text-violet-600 rounded-lg hover:bg-violet-100 transition-colors duration-200">
                                Generate Report
                            </button>
                            <button class="p-3 text-sm font-medium bg-sky-50 text-sky-600 rounded-lg hover:bg-sky-100 transition-colors duration-200">
                                Support Tickets
                            </button>
                        </div>
                    </div>
